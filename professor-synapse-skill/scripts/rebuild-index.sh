...
NOTES
  ...
  Changes are saved in place; nothing needs repackaging.
EOF
}
...
for file in "$AGENTS_DIR"/*.md; do
    ...
    if ! grep -q "Global Learned Patterns" "$file"; then
...
echo ""
echo "✅ Changes are saved in place — Professor Synapse will see the new index on the next request."
