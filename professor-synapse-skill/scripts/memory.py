...
Persistence: this store lives in the skill's memory/ folder on disk and is written
directly, so a change survives as soon as it is made — nothing to rebuild or reinstall.
"""
