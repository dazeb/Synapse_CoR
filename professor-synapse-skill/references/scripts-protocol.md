...
| `scripts/update.sh` | Fetch the latest release and build a merged update tree (preserving memory/ + custom agents) to apply in place | `bash scripts/update.sh --help` |
